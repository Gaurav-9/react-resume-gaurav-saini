    ...
    <div className="side-info-main" style={state.sideInfoStyle}>
      ...
      <ul id="social-circles">
        <li className="social-circle">
          <a target="_blank" href="https://github.com/Gaurav-9">
            <div className="circle-fill">
        ...
        <li className="social-circle">
          <a target="_blank" href="https://www.linkedin.com/in/gauravsuw/">
            <div className="circle-fill">
              <img
                alt="image"
                className="all-logos"
      ...
      <div id="contact-info">
        <div id="contact-logo-div">
          <img alt="image" id="contact-logo" src={contactLogo}></img>
        </div>
        Contact Information
      </div>
      ...
      <div id="programming-languages-header">
        <div id="contact-logo-div">
          <img alt="image" id="contact-logo" src={laptopLogo}></img>
        </div>
        Programming Languages
      </div>
      ...
      <div id="programming-language-pill">
        ...
        <div>
          ...
          <div className="programming-language-description">
            Worked with libraries such as Discord.js and React.
          </div>
        </div>
      </div>
      ...
      <div id="programming-language-pill">
        ...
        <div>
          ...
          <div className="programming-language-description">
            Developed through React web development.
          </div>
        </div>
      </div>
      ...
      <div id="programming-language-pill">
        ...
        <div>
          ...
          <div className="programming-language-description">
            Taught through university level courses and personal projects.
          </div>
        </div>
      </div>
      ...
      <a
        href={myResume}
        download="GauravSaini.pdf"
        style={{ textDecoration: "none" }}
      >
        <div id="download-button">
          <img alt="image" src={downloadLogo} id="download-button-logo"></img>{" "}
