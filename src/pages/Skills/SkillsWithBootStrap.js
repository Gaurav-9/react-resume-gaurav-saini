  ...
  [
    {
      ...
      title:"JavaScript",
      description:"Text-based programming language used both on the client-side and server-side coding",
      style:{
          borderRadius:"15px"
      }
    },

    {
     ...
     image:reactLogo,
     title:"React",
     description:"Open-source, front end, JavaScript library for building user interfaces or UI components.",
    ...
    },
    {
     ...
     },
     {
      ...
      image:cppLogo,
      title:"C++",
      description:"General-purpose programming language created by Bjarne Stroustrup as an extension of the C",
    ...
    <div id="main-skills-div">
      ...
      <Carousel  id="carousel-component">
         <Carousel.Item>
             ...
             <img alt="image" id="javascript-carousel-logo" className="carousel-card-image"src={skillCards[0].image}></img>
                <div id="javascript-title">{skillCards[0].title}</div>
               
                <div  className="carousel-card-description">{skillCards[0].description}</div>
                </div>
            </div>
        </Carousel.Item>
        ...
        <Carousel.Item>
             ...
             <div className="carousel-card-title">
             <img  alt="image" style={skillCards[1].style}className="carousel-card-image"src={skillCards[1].image}></img>
                <div>{skillCards[1].title}</div>
               
                <div className="carousel-card-description">{skillCards[1].description}</div>
                </div>
            </div>
        </Carousel.Item>
        ...
        <Carousel.Item>
             ...
             <div className="carousel-card-title">
             <img alt="image" className="carousel-card-image"src={skillCards[2].image}></img>
                <div>{skillCards[2].title}</div>
               
                <div className="carousel-card-description">{skillCards[2].description}</div>
                </div>
            </div>
        </Carousel.Item>
        ...
        <Carousel.Item>
             ...
             <div className="carousel-card-title">
             <img alt="image" className="carousel-card-image"src={skillCards[3].image}></img>
                <div>{skillCards[3].title}</div>
               
                <div className="carousel-card-description">{skillCards[3].description}</div>
                </div>
            </div>
        </Carousel.Item>
        ...
        <Carousel.Item>
             ...
             <div className="carousel-card-title">
             <img alt="image" className="carousel-card-image"src={skillCards[4].image}></img>
                <div>{skillCards[4].title}</div>
               
                <div style={skillCards[4].style} className="carousel-card-description">{skillCards[4].description}</div>
                </div>
            </div>
        </Carousel.Item>
